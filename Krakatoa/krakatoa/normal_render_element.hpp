...
class normal_render_element : public render_element<particle_render_element_interface> {
  ...
  public:
    normal_render_element( scene_context_ptr context, bool doAntialiasing, bool doScaling );
    virtual ~normal_render_element();
